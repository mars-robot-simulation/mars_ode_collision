...
namespace mars
{
    namespace ode_collision
    {
        ...
        Cylinder::Cylinder(interfaces::CollisionInterface *space,std::shared_ptr<interfaces::DynamicObject> movable, ConfigMap &config) : Object(space, movable), config(config)
        {
